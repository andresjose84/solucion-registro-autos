...
•	Crear auto con: marca, modelo, año, número de placa, color.
•	Listar los autos del usuario autenticado.
•	Editar los datos de un auto.
•	Eliminar un auto.
...
•	Tabla users
•	Tabla cars (con user_id como llave foránea)
